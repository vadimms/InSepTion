...
write.csv(tmleupmc, "C:/Users/vadim/OneDrive/Desktop/UPMC/UPMC hd imputed clean.csv")

tmleupmc <- subset(tmleupmc, 1:5000)

upmcsubset <-  tmleupmc[1:5000,]

write.csv(upmcsubset, "C:/Users/vadim/OneDrive/Desktop/UPMC/UPMC tmle subset.csv")
